...
# Form implementation generated from reading ui file 'crewDataList.ui'
#
...
"color: rgb(248, 248, 248);")
        ...
        self.comLabel.setGeometry(QtCore.QRect(40, 270, 171, 16))
        font = QtGui.QFont()
        font.setFamily("Montserrat Medium")
        self.comLabel.setFont(font)
        self.comLabel.setObjectName("comLabel")
        self.comLine = QtWidgets.QLineEdit(self.centralwidget)
        self.comLine.setGeometry(QtCore.QRect(40, 290, 721, 101))
        self.comLine.setObjectName("comLine")
        self.tableView = QtWidgets.QTableView(self.centralwidget)
        self.tableView.setGeometry(QtCore.QRect(40, 70, 721, 192))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.loginTitle.setText(_translate("MainWindow", "Tripulação"))
        self.backButton.setText(_translate("MainWindow", "Voltar"))
        self.comLabel.setText(_translate("MainWindow", "Comentários / Advertências: "))
